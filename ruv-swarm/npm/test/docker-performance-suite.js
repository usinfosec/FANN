...
async function generatePerformanceReport() {
    ...
    // Performance grade
    let grade = 'A';
    if (aggregateStats.avgMeanTime > 10) grade = 'B';
    if (aggregateStats.avgMeanTime > 50) grade = 'C';
    if (aggregateStats.avgMeanTime > 100) grade = 'D';
    if (aggregateStats.avgMeanTime > 500) grade = 'F';
